...
- [丢失 DLL 文件？这个工具帮你一键安装 Windows 运行库：AiO Runtimes | App+1 - 少数派](https://sspai.com/post/46142)

- ###### 复制粘贴

    - [好用的全平台剪切板工具，我们为你找到了这 3 款 - 少数派](https://sspai.com/post/43775)

      > 1. [ClipboardFusion](https://www.clipboardfusion.com/)
      > 2. [快贴](http://clipber.com/)
      > 3. [1Clipboard](http://1clipboard.io/)

    - [干掉Ctrl C!Windows剪切板辅助工具推荐_-泡泡网](http://www.pcpop.com/article/3435118.shtml)
...
- `XYplorer` 密钥
  ...
  用户名：`www.oyksoft.com`
  注册码：`xy01-1000-3f93-6f16-dc93-ee14-0cc4`
